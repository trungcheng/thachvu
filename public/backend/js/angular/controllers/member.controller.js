(function($, app) {
    ...
    function MemberController($rootScope, $scope, $http, $window, $timeout) {
        ...
        $scope.getResultsPage = function (name, perPage, pageNumber) {
            ...
            $http.get(app.vars.baseUrl + '/members/getAllMembers?name=' + name + '&perPage=' + perPage + '&page=' + pageNumber, {cache: false})
